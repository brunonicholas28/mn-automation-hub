...
//
// Lives in lib/jobs/ and is dispatched by api/cron/run.js, NOT as its own
// file under api/. Vercel Hobby allows 12 serverless functions per
// deployment and every file under api/ counts as one; api/ was already at
// its limit, so a thirteenth endpoint fails the whole build rather than
// just itself. That is what the dispatcher in api/cron/run.js exists for.
//
...
import { findDealsByPersonId, ENROLMENT_PIPELINE_ID, ENROLMENT_STAGES } from "../pipedrive.js";
import { SCHEDULE, sendTouch } from "../sessionRecovery.js";
